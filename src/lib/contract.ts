...
export const glassRunAbi = parseAbi([
  ...
  "function jump(uint256 run_id, uint32 step, string choice) public returns (tuple(string outcome,uint256 step,uint256 max_step,bool alive,string explanation,uint32 confidence_bp))",
  "function get_active_run(address player) public view returns (uint256)",
  "function get_run(uint256 run_id) public view returns (tuple(bool exists,string player,uint256 step,uint256 max_step,bool alive))",
